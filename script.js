...
// page12Nav1.addEventListener("mousemove", function(event) {
//     page12NavImg1.style.opacity = "1"
//     var mouseX = event.clientX;
//     var mouseY = event.clientY - 150;
//     var imgWidth = page12NavImg.offsetWidth;
//     var imgHeight = page12NavImg.offsetHeight;
//     var imgX = mouseX - (imgWidth / 2);
//     var imgY = mouseY - 180;
//     page12NavElementContainer.style.backgroundColor = "black";
//     page12NavP.style.color = "white";
//     page12NavCenterElement2I.style.color = "white";
//     page12NavCenterElement2I.style.rotate = "-40deg";
//     follow.style.scale = "0.5";

//     gsap.to(".page12-nav1-img", {
//         left: imgX,
//         top: mouseY,
...
// page12Nav1.addEventListener("mouseleave", function(event){
//     page12NavImg1.style.opacity = "0"
//     page12NavElementContainer.style.backgroundColor = "white";
//     page12NavP.style.color = "black";
//     page12NavCenterElement2I.style.color = "black";
//     page12NavCenterElement2I.style.rotate = "0deg";
// }) 
...
// page12Nav2.addEventListener("mousemove", function(event){
//     page12NavImg.style.opacity = "0"
//     page12NavImg2.style.opacity = "1"
//     var mouseX = event.clientX;
//     var mouseY = event.clientY - 150;
//     var imgWidth = page12NavImg.offsetWidth;
//     var imgHeight = page12NavImg.offsetHeight;
//     var imgX = mouseX - (imgWidth / 2);
//     var imgY = mouseY - 180;
//     page12page12Nav2ElementContainer.style.backgroundColor = "black";
//     page12page12Nav2ElementContainerparagraph.style.color = "white";
//     page12page12Nav2ElementContainericon.style.color = "white";
//     page12page12Nav2ElementContainericon.style.rotate = "-40deg";
//     follow.style.scale = "0.5";
//     gsap.to(".page12-nav1-img", {
//         left: imgX,
//         top: mouseY,
...
//     });
// })
// page12Nav2.addEventListener("mouseleave", function(event){
//     page12NavImg2.style.opacity = "0"
//     page12page12Nav2ElementContainer.style.backgroundColor = "white";
//     page12page12Nav2ElementContainerparagraph.style.color = "black";
//     page12page12Nav2ElementContainericon.style.color = "black";
//     page12page12Nav2ElementContainericon.style.rotate = "0deg";

// }) 

// // nav3

// page12Nav3.addEventListener("mousemove", function(event){
//     page12NavImg.style.opacity = "0"
//     page12NavImg2.style.opacity = "0"
//     page12NavImg3.style.opacity = "1"
//     var mouseX = event.clientX;
//     var mouseY = event.clientY - 150;
//     var imgWidth = page12NavImg.offsetWidth;
//     var imgHeight = page12NavImg.offsetHeight;
//     var imgX = mouseX - (imgWidth / 2);
//     var imgY = mouseY - 180;
//     page12page12Nav3ElementContainer.style.backgroundColor = "black";
//     page12page12Nav3ElementContainerparagraph.style.color = "white";
//     page12page12Nav3ElementContainericon.style.color = "white";
//     page12page12Nav3ElementContainericon.style.rotate = "-40deg";
//     follow.style.scale = "0.5";
//     gsap.to(".page12-nav1-img", {
//         left: imgX,
//         top: mouseY,
...
//     });
// })
// page12Nav3.addEventListener("mouseleave", function(event){
//     page12NavImg3.style.opacity = "0"
//     page12page12Nav3ElementContainer.style.backgroundColor = "white";
//     page12page12Nav3ElementContainerparagraph.style.color = "black";
//     page12page12Nav3ElementContainericon.style.color = "black";
//     page12page12Nav3ElementContainericon.style.rotate = "0deg";

// }) 

// // nav4

// page12Nav4.addEventListener("mousemove", function(event){
//     page12NavImg.style.opacity = "0"
//     page12NavImg2.style.opacity = "0"
//     page12NavImg3.style.opacity = "0"
//     page12NavImg4.style.opacity = "1"
//     page12NavImg5.style.opacity = "0"
//     page12NavImg6.style.opacity = "0"
//     page12NavImg7.style.opacity = "0"
//     var mouseX = event.clientX;
//     var mouseY = event.clientY - 150;
//     var imgWidth = page12NavImg.offsetWidth;
//     var imgHeight = page12NavImg.offsetHeight;
//     var imgX = mouseX - (imgWidth / 2);
//     var imgY = mouseY - 180;
//     page12page12Nav4ElementContainer.style.backgroundColor = "black";
//     page12page12Nav4ElementContainerparagraph.style.color = "white";
//     page12page12Nav4ElementContainericon.style.color = "white";
//     page12page12Nav4ElementContainericon.style.rotate = "-40deg";
//     follow.style.scale = "0.5";
//     gsap.to(".page12-nav1-img", {
//         left: imgX,
//         top: mouseY,
...
//     });
// })
// page12Nav4.addEventListener("mouseleave", function(event){
//     page12NavImg4.style.opacity = "0"
//     page12page12Nav4ElementContainer.style.backgroundColor = "white";
//     page12page12Nav4ElementContainerparagraph.style.color = "black";
//     page12page12Nav4ElementContainericon.style.color = "black";
//     page12page12Nav4ElementContainericon.style.rotate = "0deg";
// }) 

// // nav5
// page12Nav5.addEventListener("mousemove", function(event){
//     page12NavImg.style.opacity = "0"
//     page12NavImg2.style.opacity = "0"
//     page12NavImg3.style.opacity = "0"
//     page12NavImg4.style.opacity = "0"
//     page12NavImg5.style.opacity = "1"
//     page12NavImg6.style.opacity = "0"
//     page12NavImg7.style.opacity = "0"
//     var mouseX = event.clientX;
//     var mouseY = event.clientY - 150;
...
//     var imgX = mouseX - (imgWidth / 2);
//     var imgY = mouseY - 180;
//     page12page12Nav5ElementContainer.style.backgroundColor = "black";
//     page12page12Nav5ElementContainerparagraph.style.color = "white";
//     page12page12Nav5ElementContainericon.style.color = "white";
//     page12page12Nav5ElementContainericon.style.rotate = "-40deg";
//     follow.style.scale = "0.5";
//     gsap.to(".page12-nav1-img", {
//         left: imgX,
//         top: mouseY,
...
//     });
// })
// page12Nav5.addEventListener("mouseleave", function(event){
//     page12NavImg5.style.opacity = "0"
//     page12page12Nav5ElementContainer.style.backgroundColor = "white";
//     page12page12Nav5ElementContainerparagraph.style.color = "black";
//     page12page12Nav5ElementContainericon.style.color = "black";
//     page12page12Nav5ElementContainericon.style.rotate = "0deg";
// }) 


// // nav6

// page12Nav6.addEventListener("mousemove", function(event){
//     page12NavImg.style.opacity = "0"
//     page12NavImg2.style.opacity = "0"
//     page12NavImg3.style.opacity = "0"
//     page12NavImg4.style.opacity = "0"
//     page12NavImg5.style.opacity = "0"
//     page12NavImg6.style.opacity = "1"
//     page12NavImg7.style.opacity = "0"
//     var mouseX = event.clientX;
//     var mouseY = event.clientY - 150;
//     var imgWidth = page12NavImg.offsetWidth;
...
//     var imgX = mouseX - (imgWidth / 2);
//     var imgY = mouseY - 180;
//     page12page12Nav6ElementContainer.style.backgroundColor = "black";
//     page12page12Nav6ElementContainerparagraph.style.color = "white";
//     page12page12Nav6ElementContainericon.style.color = "white";
//     page12page12Nav6ElementContainericon.style.rotate = "-40deg";
//     follow.style.scale = "0.5";
//     gsap.to(".page12-nav1-img", {
//         left: imgX,
//         top: mouseY,
...
//     });
// })
// page12Nav6.addEventListener("mouseleave", function(event){
//     page12NavImg6.style.opacity = "0"
//     page12page12Nav6ElementContainer.style.backgroundColor = "white";
//     page12page12Nav6ElementContainerparagraph.style.color = "black";
//     page12page12Nav6ElementContainericon.style.color = "black";
//     page12page12Nav6ElementContainericon.style.rotate = "0deg";
// }) 

// // nav7

// page12Nav7.addEventListener("mousemove", function(event){
//     page12NavImg.style.opacity = "0"
//     page12NavImg2.style.opacity = "0"
//     page12NavImg3.style.opacity = "0"
//     page12NavImg4.style.opacity = "0"
...
//     var imgX = mouseX - (imgWidth / 2);
//     var imgY = mouseY - 180;
//     page12page12Nav7ElementContainer.style.backgroundColor = "black";
//     page12page12Nav7ElementContainerparagraph.style.color = "white";
//     page12page12Nav7ElementContainericon.style.color = "white";
//     page12page12Nav7ElementContainericon.style.rotate = "-40deg";
//     follow.style.scale = "0.5";
//     gsap.to(".page12-nav1-img", {
//         left: imgX,
//         top: mouseY,
...
//     });
// })
// page12Nav7.addEventListener("mouseleave", function(event){
//     page12NavImg7.style.opacity = "0"
//     page12page12Nav7ElementContainer.style.backgroundColor = "white";
//     page12page12Nav7ElementContainerparagraph.style.color = "black";
//     page12page12Nav7ElementContainericon.style.color = "black";
//     page12page12Nav7ElementContainericon.style.rotate = "0deg";
// }) 
